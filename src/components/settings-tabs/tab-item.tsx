...
export function TabItem({ value, isSelected }: TabItemProps) {
  return (
    <Tabs.Trigger
      key={value}
      value={value}
      className="group relative whitespace-nowrap px-1 pb-4 text-sm font-medium text-zinc-500 outline-none hover:text-violet-700 data-[state=active]:text-violet-700 dark:text-zinc-400 dark:hover:text-violet-300 dark:data-[state=active]:text-violet-300"
    >
